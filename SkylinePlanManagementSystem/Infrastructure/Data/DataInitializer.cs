    ...
    public static class DataInitializer
    {
        public static IApplicationBuilder UseDataInitializer(this IApplicationBuilder builder)
        {
            using(var scope = builder.ApplicationServices.CreateScope())
            {
                ...
                var departments = new[]
                {
                    new Department { Name = "综合管理部", Budget = 350000, StartDate = DateTime.Parse("2017-09-01") },
                    new Department { Name = "财务管理部", Budget = 100000, StartDate = DateTime.Parse("2017-09-01") },
                    new Department { Name = "工程管理中心", Budget = 350000, StartDate = DateTime.Parse("2017-09-01") },
                    new Department { Name = "营销管理中心", Budget = 100000, StartDate = DateTime.Parse("2017-09-01") },
