...
namespace SkylinePlanManagementSystem.Infrastructure.Repositories
{
    ...
    /// <typeparam name="Tentity,TPrimaryKey">传入仓储的主键类型</typeparam>
    public interface IRepository<TEntity, TPrimaryKey> where TEntity : class
    {
        ...
        /// <summary>
        /// 通过传入筛选条件查询实体信息，如果查询不到返回值，则会返回null
        /// </summary>
        ...
        /// 如果条件比较多，则待删除的实体也比较多，这可能会导致性能问题
        /// </summary>
        /// <param name="entity">筛选实体的条件</param>
        ...
        /// <summary>
        /// 获取此存储中所有实体的总和（如果预期返回值大于了Int.MaxValue值，则推荐该方法），
        /// 简单来说就是返回值为long类型
        ...
        /// <summary>
        /// 支持条件筛选获取此存储中的所有实体的总和（如果预期返回值大于了Int.MaxValue值，则推荐该方法），
        /// 简单来说就是返回值为long类型
        /// <see cref="int.MaxValue"/>
        /// </summary>
        /// <returns>实体的总数</returns>
